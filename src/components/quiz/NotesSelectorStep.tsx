                            ...
                            {selectedNotes.map((note) => (
                                ...
                                >
                                    <span className="text-[#6A1B9A]">
                                        <NoteIcon name={note.icon} size={16} />
                                    </span>
                    ...
                    <div className="mt-5 border-t border-[#dcdcdc] pt-5">
                        ...
                        <div className="mt-3 flex flex-wrap gap-2">
                            {disabledSelectedNotes.map((note) => (
                                ...
                                >
                                    <span className="text-[#6A1B9A]"><NoteIcon name={note.icon} size={14} /></span>
                                    <span>{note.label}</span>
                                </span>
                            ))}
                        </div>
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <motion.span
                                            ...
                                            className="flex h-12 w-12 items-center justify-center border border-[#dcdcdc] bg-[#f3f3f3] text-[#6A1B9A]"
                                        >

...
const iconPaths: Record<string, string> = {
    ...
    unisex: 'M12 8a4 4 0 108 0 4 4 0 00-8 0zm4-6v2m0 12v2m-6-8H8m12 0h-2m-1.5-5.5L15.2 6.8m-4.7 10.4l-1.3 1.3M6.8 6.8L5.5 5.5m10.4 10.4l1.3 1.3',
    spring: 'M12 22c-4-6-8-9-8-13a8 8 0 0116 0c0 4-4 7-8 13zm-2-9h4m-2-2v4',
    ...
    fall: 'M12 3L8 21h8L12 3zm-4 7h8m-7 4h6',
    winter: 'M12 2l2 7h7l-5.5 4 2 7L12 16l-5.5 4 2-7L3 9h7l2-7z',
    calendar: 'M4 5h16v14H4V5zm0 4h16M8 2v4m8-4v4',
    light: 'M12 4a8 8 0 018 8M12 4a8 8 0 00-8 8m8-8v2m0 14a8 8 0 01-8-8m8 8a8 8 0 008-8m0 0h-2',
    moderate: 'M4 12h4m4-8v4m0 8v4m-6.5-2.5L9 13m6.5-6.5L15 11m-11 1a8 8 0 0116 0',
    strong: 'M12 2L4 22h16L12 2zm0 6l3 10H9l3-10z',
    check: 'M5 13l4 4L19 7',

    // Category icons
    citrus: 'M12 2C7 2 3 6 3 11s4 9 9 9 9-4 9-9-4-9-9-9zm0 4c2.8 0 5 2.2 5 5s-2.2 5-5 5-5-2.2-5-5 2.2-5 5-5z',
    floral: 'M12 3C9 3 7 5.5 7 8s2 5 5 8c3-3 5-5.5 5-8s-2-5-5-5z',
    gourmand: 'M4 6h16v12H4V6zm2 2v8h12V8H6z',
    woody: 'M12 2L5 22h14L12 2z',
    spicy: 'M12 3C9 3 7 5.5 7 8s2 5 5 8c3-3 5-5.5 5-8s-2-5-5-5z',
    ambery: 'M12 2L4 20h16L12 2zm0 5l5 11H7l5-11z',
    ...
    fruity: 'M12 3C7.6 3 4 6.6 4 11s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8z',

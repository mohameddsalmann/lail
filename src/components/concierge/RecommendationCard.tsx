        ...
        >
            ...
            <div className="space-y-4 p-5 sm:p-6">
                <div>
                    ...
                    <p className="mt-0.5 text-xs text-[#8A7E72]">Inspired by {rec.inspiredBy}</p>
                </div>
                ...
                <div className="space-y-2 text-[13px] text-[#5A4E42]">
                    <div className="flex items-start gap-2">
                        ...
                        <span><span className="font-medium text-[#2C1810]">Best for:</span> {rec.bestFor}</span>
                    </div>
                    <div className="flex items-start gap-2">
                        <span className="mt-0.5 text-[#C4A265]">◆</span>
                        <span><span className="font-medium text-[#2C1810]">Why it&apos;s special:</span> {rec.whySpecial}</span>
                    </div>
                </div>

...
const moodChoices = [
    { id: 'morning', label: 'Sunny Morning', emoji: '☀️', hint: 'Light, fresh, energizing' },
    { id: 'night', label: 'Night Out', emoji: '🌙', hint: 'Bold, warm, magnetic' },
];

const scentChoices = [
    { id: 'sweet', label: 'Sweet & Gourmand', emoji: '🍦', hint: 'Vanilla, caramel, fruits' },
    { id: 'woody', label: 'Bold & Woody', emoji: '🪵', hint: 'Oud, leather, wood' },
    { id: 'fresh', label: 'Fresh & Clean', emoji: '🌊', hint: 'Citrus, mint, aquatic' },
];

const moodLabels: Record<string, string> = {
    morning: 'Sunny morning ☀️',
    night: 'Night out 🌙',
};
    ...
    return (
        <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-2xl flex-col px-4 pb-10 pt-6 sm:px-6">
            ...
            >
                ...
                <h1 className="text-lg font-semibold text-[#2C1810]">Cozy Concierge</h1>
                <p className="mt-1 text-xs tracking-wide text-[#8A7E72]">Your personal fragrance consultant</p>
            </motion.div>

            <div className="flex flex-1 flex-col gap-5">
                {/* Greeting */}
                <ConciergeBubble from="ai" delay={0.2}>
                    Welcome to <span className="font-semibold">Cozy Fragrances</span> ✨
                    <br /><br />
                    Let&apos;s find your signature scent in seconds. To start — are we setting the mood for a{' '}
                    <span className="font-medium">sunny morning</span> or a{' '}
                    <span className="font-medium">mysterious night out</span>?
                </ConciergeBubble>
                ...
                <AnimatePresence>
                    {step === 'filter' && (
                        ...
                        >
                            <ConciergeBubble from="ai" delay={0.2}>
                                {mood === 'morning'
                                    ? 'Love that energy! ☀️ One more thing —'
                                    : 'Great taste! 🌙 One more thing —'}
                                <br /><br />
                                Do you lean towards{' '}
                                <span className="font-medium">sweet & gourmand</span>,{' '}
                                <span className="font-medium">bold & woody</span>, or{' '}
                                <span className="font-medium">fresh & clean</span>?
                            </ConciergeBubble>
                        </motion.div>
                    )}
                </AnimatePresence>
                    ...
                    {step === 'results' && (
                        ...
                        >
                            <ConciergeBubble from="ai">
                                Here&apos;s your curated edit — handpicked to match your vibe. Each one is crafted for{' '}
                                <span className="font-medium">maximum presence with ultimate comfort</span>.
                            </ConciergeBubble>

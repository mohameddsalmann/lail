  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-[#e0e0e0]">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm text-[#4a4a4a]">
            <Link href="/" className="hover:text-[#6A1B9A] transition">Home</Link>
            <Link href="/quiz" className="hover:text-[#6A1B9A] transition">Find Your Scent</Link>
            <a
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-[#C9A84C] text-sm uppercase tracking-[0.3em] mb-4 font-medium">
              Your Egyptian Gateway to Luxurious Fragrances
            </p>
            <h2 className="text-4xl md:text-6xl font-light text-white mb-6 leading-tight font-serif">
              Discover Your<br />
              <span className="font-semibold italic">Perfect Scent</span>
            </h2>
            <p className="text-white/70 mb-10 text-lg max-w-md mx-auto">
              Not sure which fragrance is right for you? Take our personalized quiz to find your ideal match.
            </p>
            <Link
              href="/quiz"
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6">
            ...
            <h3 className="font-medium text-[#1a1a1a] mb-2 font-serif">Personalized</h3>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="font-medium text-[#1a1a1a] mb-2 font-serif">Affordable Luxury</h3>
            <p className="text-sm text-[#4a4a4a]">
          ...
          <div className="text-center p-6">
            ...
            <h3 className="font-medium text-[#1a1a1a] mb-2 font-serif">Curated Quality</h3>
            <p className="text-sm text-[#4a4a4a]">
              Fragrances inspired by the world&apos;s finest brands
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#f5f5f5] py-16">
        <div className="container mx-auto px-4">
          <h3 className="text-center text-2xl font-light text-[#1a1a1a] mb-2 font-serif">Popular Picks</h3>
      ...
      <div className="py-16 text-center bg-white">
        <div className="w-16 h-[2px] bg-[#C9A84C] mx-auto mb-6" />
        <p className="text-[#4a4a4a] mb-6 font-serif text-lg">Ready to find your signature scent?</p>
        <Link
          href="/quiz"
